# --------------------------------------------------------
# JiT Model for Rectified Flow - Single Channel Adaptation
# Based on JiT-main/model_jit.py
# Modified for CT images (1 channel instead of 3)
# --------------------------------------------------------
import torch
...
class BottleneckPatchEmbed(nn.Module):
    """ Image to Patch Embedding - Single Channel Version """
...
class JiT(nn.Module):
    """
    Just image Transformer - Single Channel Version for CT Images
    """
    def __init__(
        self,
        input_size=256,
        patch_size=16,
        in_channels=1,  # Changed from 3 to 1 for CT images
        hidden_size=1024,
        depth=24,
        num_heads=16,
        mlp_ratio=4.0,
